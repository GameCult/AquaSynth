...
const document = {
  ...
  description:
    "AquaSynth accepts .aqua DSL and Weksa utterance handoffs, compiles Faust-native instruments, owns live streaming patch sessions, and publishes controllable synth state through CultMesh/Eve.",
  ...
  serviceVerse: {
    ...
    owns: [
      ...
      "compiled instrument sessions",
      "live streaming patch sessions",
      "live session control state",
      "live session lifecycle receipts",
  ...
  nestedVerses: [
    ...
    },
    {
      ...
      authority: "AquaSynth native host and live-session owner",
      schemas: [
        "aquasynth.compiled_instrument_session.v1",
        "aquasynth.live_instrument_session.v1",
        "aquasynth.command.instrument_open.v1",
        "aquasynth.command.instrument_control.v1",
        "aquasynth.command.instrument_block.v1",
        "aquasynth.command.instrument_close.v1",
  ...
  schemaWitnessFamilies: [
    ...
    },
    {
      ...
      durableShape: ".aquasynth/sessions/{sessionId}.cc and .aquasynth/live-sessions/{sessionId}.cc",
    },
    {
      family: "render",
  ...
  commandBoundaries: [
    ...
    {
      id: "aquasynth.command.instrument.open",
      owner: "AquaSynth",
      acceptedByFixture: false,
      allowedInputs: [".aqua DSL", "block size", "initial semantic control values"],
      emits: ["aquasynth.compiled_instrument_session.v1", "aquasynth.live_instrument_session.v1", "aquasynth.instrument_open_receipt.v1"],
    },
    {
      id: "aquasynth.command.instrument.control",
      owner: "AquaSynth",
      acceptedByFixture: false,
      allowedInputs: ["live session id", "semantic control values"],
      emits: ["aquasynth.live_instrument_session.v1", "aquasynth.instrument_control_receipt.v1"],
    },
    {
      id: "aquasynth.command.instrument.block",
      owner: "AquaSynth",
      acceptedByFixture: false,
      allowedInputs: ["live session id", "frame count", "optional control values"],
      emits: ["aquasynth.live_instrument_session.v1", "aquasynth.instrument_block_receipt.v1"],
    },
    {
      id: "aquasynth.command.instrument.close",
      owner: "AquaSynth",
      acceptedByFixture: false,
      allowedInputs: ["live session id"],
      emits: ["aquasynth.live_instrument_session.v1", "aquasynth.instrument_close_receipt.v1"],
    },
    {
      id: "aquasynth.command.instrument.sample",
      owner: "AquaSynth",
      acceptedByFixture: false,
      allowedInputs: [".aqua DSL", "duration", "sample format", "optional semantic control values"],
  ...
  loweringRules: [
    "AquaSynth owns learned embeddings, synth controls, Faust compilation, native binary lifetime, compiled instrument sessions, live streaming patch sessions, and sampled outputs.",
    ...
    "Eve surfaces control and inspect sessions through CultMesh command documents and retained live-session state; they do not own audio state.",
  ],
};
