...
public static class PinkTromboneReference
{
    ...
    public static ReferenceRebuild CurrentAquaSynthProxy() =>
        new(
            ...
            [
                new("runtime_controls", "/pink/frequency,/pink/intensity,/pink/tenseness,/pink/tongue/index,/pink/tongue/diameter,/pink/velum", "AquaSynth can expose stable runtime parameter paths."),
                new("glottal_pitch_pressure_proxy", "oscillator-frequency-plus-gain", "AquaSynth can drive pitch/loudness-like controls without recompiling."),
                new("turbulence_proxy", "noise-voice", "AquaSynth can emit a separate noise source for frication pressure."),
                new("formant_proxy", "static-resonant-bandpass-bank", "AquaSynth can sketch vowel/body color with formant filters.")
            ],
            [
